  ...
  actions: {
    ...
    async loadDetail(id) {
      ...
      this.detail = await sendRequest(
        urls.MATERIALS.MATERIALS.DETAIL,
        {},
        { id }
      )
    ...
    async deleteItem(id) {
      ...
      try {
        await sendRequest(
          urls.MATERIALS.MATERIALS.DELETE,
          {},
          { id: id }
        )
      } catch (e) {
    ...
    async createItem(data) {
      ...
      try {
        await sendRequest(
          urls.MATERIALS.MATERIALS.CREATE,
          data
        )
      } catch (e) {
        throw e
    ...
    async updateItem(id, data) {
      ...
      try {
        await sendRequest(
          urls.MATERIALS.MATERIALS.UPDATE,
          data,
          { id: id }
        )
      } catch (e) {
