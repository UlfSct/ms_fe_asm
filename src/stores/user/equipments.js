  ...
  actions: {
    async loadList(filters={}) {
      ...
      let response = await sendRequest(
        urls.EQUIPMENTS.EQUIPMENTS.LIST,
        {},
        {},
        filters
      )
    ...
    async loadDetail(id) {
      ...
      this.detail = await sendRequest(
        urls.EQUIPMENTS.EQUIPMENTS.DETAIL,
        {},
        { id }
      )
    ...
    async deleteItem(id) {
      ...
      try {
        await sendRequest(
          urls.EQUIPMENTS.EQUIPMENTS.DELETE,
          {},
          { id: id }
        )
      } catch (e) {
    ...
    async createItem(data) {
      ...
      try {
        await sendRequest(
          urls.EQUIPMENTS.EQUIPMENTS.CREATE,
          data
        )
      } catch (e) {
        throw e
    ...
    async updateItem(id, data) {
      ...
      try {
        await sendRequest(
          urls.EQUIPMENTS.EQUIPMENTS.UPDATE,
          data,
          { id: id }
        )
      } catch (e) {
