  ...
  actions: {
    ...
    async loadDetail(id) {
      ...
      this.detail = await sendRequest(
        urls.MODELS.ADMIN.MODELS.DETAIL,
        {},
        { id }
      )
    ...
    async deleteItem(id) {
      ...
      try {
        await sendRequest(
          urls.MODELS.ADMIN.MODELS.DELETE,
          {},
          { id: id }
        )
      } catch (e) {
    ...
    async createItem(data) {
      ...
      try {
        await sendRequest(
          urls.MODELS.ADMIN.MODELS.CREATE,
          data
        )
      } catch (e) {
        throw e
    ...
    async updateItem(id, data) {
      ...
      try {
        await sendRequest(
          urls.MODELS.ADMIN.MODELS.UPDATE,
          data,
          { id: id }
        )
      } catch (e) {
