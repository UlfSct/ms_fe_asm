...
<template>
  <v-card class="ma-3">
    <v-toolbar flat density="comfortable">
      <v-toolbar-title>Список доступных материалов</v-toolbar-title>
      <v-text-field
    ...
    >
      ...
      <template v-slot:item.actions="{ item }">
        <v-tooltip v-if="!item.is_global && item.is_mine" text="Редактировать материал" location="bottom">
          <template v-slot:activator="{ props }">
            <v-btn
              v-bind="props"
              size="30"
        ...
        <v-tooltip v-if="item.can_delete && !item.is_global && item.is_mine" text="Удалить материал" location="bottom">
          <template v-slot:activator="{ props }">
            <v-btn
              v-bind="props"
              size="30"
